      ...
      <div className="container max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          <FeatureCard 
            ...
            title="Denná prax"
            description="Prebuďte sa so svitaním na ranné Hathajóga flow a ukončite deň regeneračnými večernými lekciami pod vedením skúsených učiteľov. Každý deň je postavený na vedomom pohybe, dychu a vnímaní tela i duše."
          />
          <FeatureCard 
            icon={<Heart className="w-8 h-8" />}
            title="Vedomý život"
            description="Objavte silu rastlinnej ajurvédskej stravy, digitálneho detoxu a každodenných rituálov vedomého života. Počas pobytu ich prirodzene začleníte do tela a mysle – a plynulo v nich budete pokračovať aj po návrate domov."
          />
          <FeatureCard 
