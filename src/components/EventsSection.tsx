...
const activeIds = ["blatinka-retreat", "krpacovo-soul", "cyprus-awakening", "necpaly-retreat"];
const upcomingIds = ["bali-bliss", "costa-rica", "provence-haute-alpes", "croatia-harmony"];
      ...
      <div className="container max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            Sedem jedinečných destinácií, jeden transformačný zážitok. Všetky pobyty zahŕňajú ubytovanie, dennú jogu a meditáciu, workshopy, organické jedlá a unikátne zážitky.
          </p>
        </div>
