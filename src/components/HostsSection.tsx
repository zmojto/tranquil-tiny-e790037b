      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              Sabína sa s vami podelí o svoje skúsenosti s etikoterapiou a meditačnou praxou.
              <br />
        ...
        <div className="mt-16 pt-12 border-t border-border/50 grid md:grid-cols-2 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              ako sú <em>Práca s pozornosťou</em>, <em>Mentálna odolnosť</em> či <em>Spokojnosť ako voľba</em>,
